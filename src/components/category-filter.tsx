...
export function FilterSearchComponent() {
  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-10 mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      
      {/* Category Filter */}
      <div className="w-full sm:w-auto overflow-x-auto hide-scrollbar flex gap-2 pb-1 scroll-smooth snap-x">
